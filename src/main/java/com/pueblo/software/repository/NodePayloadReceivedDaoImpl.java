...
@Repository("nodePayloadReceivedDao")
@Transactional
public class NodePayloadReceivedDaoImpl extends AbstractDao<Long, NodePayloadReceived> implements NodePayloadReceivedDao{

	private static final Logger LOG = Logger.getLogger(NodePayloadReceivedDaoImpl.class);
